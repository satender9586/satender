...
const Scalability = () => {
  return (
    <Box
      sx={{ padding: "0rem 3rem", paddingBottom: "3.5rem", paddingTop: "2rem" }}
    >
      ...
      >
        <Box gap={2}>
          ...
          <Box display={"flex"} justifyContent={"center"}>
            <Typography fontSize={"15px"} letterSpacing={1} color={"#6F7F8F"}>
              highly scalable Object Storage solutions and{" "}
            </Typography>
          </Box>
          <Box display={"flex"} justifyContent={"center"}>
            <Typography fontSize={"15px"} letterSpacing={1} color={"#6F7F8F"}>
              experience limitless scalability with a flexible{" "}
            </Typography>
          </Box>
          <Box display={"flex"} justifyContent={"center"}>
            <Typography fontSize={"15px"} letterSpacing={1} color={"#6F7F8F"}>
        ...
        <Box gap={2}>
          ...
          <Box display={"flex"} justifyContent={"center"}>
            <Typography fontSize={"15px"} letterSpacing={1} color={"#6F7F8F"}>
              recovery, high-performance computing, media,{" "}
            </Typography>
          </Box>
          <Box display={"flex"} justifyContent={"center"}>
            <Typography fontSize={"15px"} letterSpacing={1} color={"#6F7F8F"}>
              AI/ML, e-commerce, finance, and healthcare and more.{" "}
            </Typography>
          </Box>
        </Box>
      </Box>
