...
const Growth1 = () => {
  return (
    <Box sx={{ bgcolor: "#EFF5FF", padding: "1.5rem 3rem",paddingBottom:"2.5rem" }}>
      <Box >
        <Typography
          sx={{
            color: "black",
      ...
      <Box >
        <Typography
          sx={{ color: "#677788", textAlign: "Center", fontSize: "20px",letterSpacing:"0.1rem" }}
        >
       Compare and evaluate different storage options and find out how Cloude Data is more reliable 
        </Typography>
      </Box>
      <Box>
        <Typography
          sx={{ color: "#677788", textAlign: "Center", fontSize: "20px",letterSpacing:"0.1rem" }}
        >
          than other providers and make an informed decision on which solution best meets your needs.
        </Typography>
      </Box>
        ...
        <Grid container>
          ...
          <Grid xs={9} item>
            <Box sx={{display:"flex",gap:1.5}}>
              ...
              <Box sx={{display:"flex",alignItems:"center"}}><Typography sx={{fontSize:"21px" ,color:"#677788",marginRight:"10px"}}>Rs. 6000</Typography><Typography sx={{color:"#677788",marginRight:"10px"}}> / month</Typography></Box>
            </Box>
            <Box>
        ...
        <Grid container>
          ...
          <Grid xs={9} item>
            <Box sx={{display:"flex",gap:1.5}}>
              ...
              <Box sx={{display:"flex",alignItems:"center"}}><Typography sx={{fontSize:"21px" ,color:"#677788",marginRight:"10px"}}>Rs. 35,600 </Typography><Typography sx={{color:"#677788",marginRight:"10px"}}>/ month</Typography></Box>
            </Box>
            <Box>
              <Box><Typography sx={{fontSize:"15px" ,color:"#677788",marginRight:"10px"}}>Cloud server - 8v CPU, 32 GB RAM, 480 GB Disk, 1000 GB Traffic</Typography></Box>
            </Box>
